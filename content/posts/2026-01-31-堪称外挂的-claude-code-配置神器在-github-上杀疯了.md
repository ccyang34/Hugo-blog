...
他们通过配置 MCP 工具，比如 GitHub MCP, Supabase MCP等。
...
在新项目启动阶段：可以先用 /plan 命令调用 planner/architect 等 agents，帮助梳理目标功能、选择技术栈并划分模块边界。
...
你可以把这个开源项目作为一个**生产级起步模板，高效用 Claude Code 搭建严肃的软件工程工作流，在极短时间内产出可 demo 的产品。******不需要自己从 0 写 agents / skills / hooks。****03
