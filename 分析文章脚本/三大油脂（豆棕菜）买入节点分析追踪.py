...
STYLE_CONFIG = {
    'Y0':  {'line': '#E65100', 'strat': '#BF360C', 'tact': '#FB8C00', 'bg': '#FFF3E0'}, # 橙色系-豆油
    'P0':  {'line': '#2E7D32', 'strat': '#1B5E20', 'tact': '#66BB6A', 'bg': '#E8F5E9'}, # 绿色系-棕榈油
    'OI0': {'line': '#1976D2', 'strat': '#0D47A1', 'tact': '#42A5F5', 'bg': '#E3F2FD'}  # 蓝色系-菜油
}
